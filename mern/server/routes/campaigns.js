...
router.post("/", async (req, res) => {
    try {
        ...
        console.error(err);
        res.status(500).send("Error adding campaign");
    }
});

// This section will help you get a list of all the campaigns.
...
router.get("/:id", async (req, res) => {
  try {
    ...
    // } 
      ...
      let query = { campaignID: req.params.id, [key]: value }; // campaign id a string here, doesn't need to be cast to objectid
